...
class Enable
{
    ...
    public function __invoke()
    {
        ...
        $develConfigDist = (isset($this->projectDir) && ! empty($this->projectDir))
        ...
        $develLocalDist = (isset($this->projectDir) && ! empty($this->projectDir))
        ...
        if (file_exists($develLocalDist)) {
            ...
            $develLocal = (isset($this->projectDir) && ! empty($this->projectDir))
